      ...
      <div className="max-w-[90vw] mx-auto rounded-xl shadow-2xl overflow-hidden bg-white">
        ...
        <div className="flex noto-serif flex-col md:flex-row items-center gap-10 p-8 md:p-12 lg:p-16">
          ...
          <div ref={heroTextRef} className="md:w-1/2 text-gray-800">
            ...
            <p className="mb-4 text-lg leading-relaxed">
              At Techwarezen, our expert React developers leverage its robust ecosystem to deliver fast, interactive, and highly maintainable applications. Whether you need a single-page application (SPA), a complex dashboard, or a progressive web app (PWA), React provides the flexibility and performance required.
            </p>
