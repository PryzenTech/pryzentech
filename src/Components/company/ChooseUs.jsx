      ...
      <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        ...
        <section className="text-center mb-16">
          ...
          <p ref={introTextRef} className="text-lg sm:text-xl text-gray-700 max-w-3xl mx-auto">
            Choosing the right digital partner is crucial for your business success. At PryzenTech, we combine expertise, innovation, and a client-first approach to deliver unparalleled web solutions.
          </p>
        </section>
